type ModeType = "variation" | "create" | "edit";
...
export const TopModeSwitcher = ({ mode = "create" }: TopModeSwitcherProps): JSX.Element => {
  const isCreate = mode === "create";

  return (
    <div className="h-[33px] w-[371px] rounded-[19.06px] border-[0.5px] border-solid border-white bg-[#c3c2c280] shadow-[inset_0_1px_0_rgba(255,255,255,0.40),inset_1px_0_0_rgba(255,255,255,0.32),inset_0_-1px_1px_rgba(0,0,0,0.11),inset_-1px_0_1px_rgba(0,0,0,0.08)] backdrop-blur-[1.6px] backdrop-brightness-[100.0%] backdrop-saturate-[100.0%] [-webkit-backdrop-filter:blur(1.6px)_brightness(100.0%)_saturate(100.0%)]">
      <div className="relative -mt-1 ml-5 flex h-[39px] w-[371px] items-center gap-4 px-[23px] py-0">
        <button className="all-[unset] box-border inline-flex items-start gap-[3px]">
          <VariationIcon />
          <div className="[font-family:'Aeonik_Pro-Medium',Helvetica] text-base font-medium leading-[17.0px] tracking-[-0.16px] text-[#464545]">
            Variation
          </div>
        </button>

        <button
          className={`all-[unset] box-border flex h-[33px] w-[129px] items-center self-center px-6 py-0 rounded-[35.75px] border-[0.4px] border-solid ${
            isCreate
              ? "border-[#ffffff4c] bg-[#85848433] text-white shadow-[0px_4px_4px_#00000040,inset_0_1px_0_rgba(255,255,255,0.40),inset_1px_0_0_rgba(255,255,255,0.32),inset_0_-1px_1px_rgba(0,0,0,0.11),inset_-1px_0_1px_rgba(0,0,0,0.08)]"
              : "border-transparent bg-transparent text-[#464545]"
          } backdrop-blur-[1.6px] backdrop-brightness-[100.0%] backdrop-saturate-[100.0%] [-webkit-backdrop-filter:blur(1.6px)_brightness(100.0%)_saturate(100.0%)]`}
        >
          <div className="flex w-full items-center gap-[5px]">
            <CreateIcon />
            <div className="w-[60px] text-center [font-family:'Aeonik_Pro-Medium',Helvetica] text-[17.7px] font-medium leading-[18.8px] tracking-[-0.18px] text-current">
              Create
            </div>
          </div>
        </button>

        <button className="all-[unset] box-border relative mr-[-16px] flex w-[90px] items-end gap-[3px]">
          <EditIcon />
          <div className="[font-family:'Aeonik_Pro-Medium',Helvetica] text-base font-medium leading-[17.0px] tracking-[-0.16px] text-[#464545]">
            Edit
          </div>
