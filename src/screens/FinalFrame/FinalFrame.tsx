...
export const FinalFrame = (): JSX.Element => {
  return (
    <div
      className="bg-white w-full min-w-[1512px] min-h-[984px] relative"
      data-model-id="52:399"
    >
      <EditorStepNavigationSection />
      <div className="absolute top-[82px] left-0 w-[1512px] h-[902px] bg-[#00000001] rounded-xl backdrop-blur-[2.5px] backdrop-brightness-[100.0%] backdrop-saturate-[100.0%] [-webkit-backdrop-filter:blur(2.5px)_brightness(100.0%)_saturate(100.0%)] shadow-[inset_0_1px_0_rgba(255,255,255,0.40),inset_1px_0_0_rgba(255,255,255,0.32),inset_0_-1px_1px_rgba(0,0,0,0.13),inset_-1px_0_1px_rgba(0,0,0,0.11)]" />

      <div className="absolute top-[82px] left-0 w-[1512px] h-[902px] bg-[url(https://c.animaapp.com/ViJx1BUZ/img/noise-texture-background-.png)] bg-[100%_100%]" />

      <div className="absolute w-[27.65%] top-[calc(50.00%_-_334px)] left-0 h-[799px] rounded-xl shadow-[2px_2px_4px_#00000040]" />
      ...
      <div className="absolute top-[116px] left-[478px] w-[1010px] h-[849px] flex">
        <div className="w-[1010px] h-[849px] relative rounded-xl overflow-hidden shadow-[4px_4px_4px_#00000040]">
          <div className="absolute top-0 left-0 w-[1069px] h-6 flex">
            <img
              className="w-[1010px] h-6 aspect-[44] object-cover"
              alt="Zoombar"
          ...
          <img
            className="absolute top-6 left-[23px] w-[987px] h-[825px]"
            alt="Container"
            src="https://c.animaapp.com/ViJx1BUZ/img/container-6.svg"
          />
